...
from .endpoints import auth, analytics, dashboard, users, circulation, reports, settings, books, locations, fines
...
# api_router.include_router(inventory.router, prefix="/inventory", tags=["Acquisitions"])
